...
class ZipSign extends React.Component {
        ...
        sequence.onStop = () => {
          if (sequence.files.length > 0) {
            ...
            if (signatureVerified) {
              ...
              this.createTransaction(transactionInput, transaction => {
                this.setState(
                  {
  ...
  createTransaction = (input, callback) => {
    console.log("Input to create transaction:", input);
    let privateKeyData = this.state.privateKeyData;
    if (privateKeyData) {
      let privateKeyBuffer = Buffer.from(privateKeyData.privateKey, "hex");
      if (privateKeyBuffer) {
        ...
        if (privateKey) {
          ...
          console.log("Transaction seri", serializedTransaction);
        }
      }
    }
  };
